...
st.markdown('''
    <p style="font-size: 20px;">
            Machine Learning เทคโนโลยีประโยชน์ครอบจักรวาล
        <a href="https://www.cyberelite.co.th/blog/machine-learning/" 
           target="_blank" style="font-size: 25px; color: blue;">
           Click here
        </a>. <br>
            หาก AI เป็นปัญญาประดิษฐ์แล้ว Machine Learning คืออะไร
        <a href="https://www.aware.co.th/th/machine-learning-%E0%B8%84%E0%B8%B7%E0%B8%AD%E0%B8%AD%E0%B8%B0%E0%B9%84%E0%B8%A3/" 
           target="_blank" style="font-size: 25px; color: blue;">
           Click here
        </a>. <br>
            Machine Learning คืออะไร สำคัญอย่างไรต่อโลกธุรกิจยุคนี้?
        <a href="https://talkatalka.com/blog/what-is-machine-learning/" 
           target="_blank" style="font-size: 25px; color: blue;">
           Click here
        </a>.    
        <br>
